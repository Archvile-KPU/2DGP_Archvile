...
import gfw
import player
import enemy as generator
import level as bg
import timer as highscore

STATE_IN_GAME, STATE_GAME_OVER = range(2) #actually Boolean

def collides_distance(a,b):
    ax, ay = a.pos
    bx, by = b.pos
    radius_sum = a.radius + b.radius
    #distance = math.sqrt((ax - bx)**2 + (ay - by)**2) #sqrt takes resources
